<?php echo $this->form('search-form', $options['form_attributes']); ?>
    ...
    <fieldset id="record-types">
        <?php foreach ($record_types as $key => $value): ?>
            <a href="#" class="record-type" tabindex="0"><?php echo $this->formCheckbox('record_types[]', $key, in_array($key, $filters['record_types']) ? array('checked' => true, 'id' => 'record_types-' . $key, 'tabindex' => '-1') : array('tabindex' => '-1')); ?> <?php echo $value; ?></a>
        <?php endforeach; ?>
    </fieldset>
