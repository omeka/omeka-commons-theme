...
<form <?php echo tag_attributes($formAttributes); ?>>
    ...
    <div id="search-narrow-by-fields" class="field">
        ...
        foreach ($search as $i => $rows): ?>
            <div class="search-entry">
                ...
                ?>
                <button type="button" class="remove_search" disabled="disabled" style="display: none;"><?php echo __('Remove this field'); ?></button>
            </div>
        <?php endforeach; ?>
        </div>
    ...
    <div>
        <input type="submit" class="submit" name="submit_search" id="submit_items_search" value="<?php echo __('Search items'); ?>" />
    </div>
</form>
